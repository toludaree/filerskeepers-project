...
class TestProcess(unittest.TestCase):
    ...
    def test__process_book_1(self):
        self.assertEqual(
            process.process_book(self.book1, "https://books.toscrape.com/catalogue/a-light-in-the-attic_1000/index.html"),
            Book(
    ...
    def test__process_book_2(self):
        self.assertEqual(
            process.process_book(self.book2, "https://books.toscrape.com/catalogue/angels-walking-angels-walking-1_662/index.html"),
            Book(
    ...
    def test__process_book_3(self):
        self.assertEqual(
            process.process_book(self.book3, "https://books.toscrape.com/catalogue/the-lonely-city-adventures-in-the-art-of-being-alone_639/index.html"),
            Book(
    ...
    def test__process_book_4(self):
        self.assertEqual(
            process.process_book(self.book4, "https://books.toscrape.com/catalogue/alice-in-wonderland-alices-adventures-in-wonderland-1_5/index.html"),
            Book(
